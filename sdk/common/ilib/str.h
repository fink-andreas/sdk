...
public:
    ...
    static word ucs2_chr2lwr(word w) { return (w < sizeof(ucs2_to_lower_case)) ? ucs2_to_lower_case[w] : w; }
	static word ucs2_chr2upr(word w) { return (w < sizeof(ucs2_to_upper_case))? ucs2_to_upper_case[w] : w; }
