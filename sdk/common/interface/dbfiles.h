...
public:
    ...
    virtual class IDbFilesGet * Get(class UTask * user, ulong64 id, unsigned length, unsigned offset = 0, bool progress = false) = 0;
...
public:
    ...
    virtual void Read(unsigned length, bool last=false) = 0;
};
