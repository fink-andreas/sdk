...
public:
    ...
    virtual void PassErrorToUser(htttp_error_t err) = 0;

    virtual void SetRequestType(http_request_type_t reqType, const char * resourceName, size_t contentLength = 0) = 0;
