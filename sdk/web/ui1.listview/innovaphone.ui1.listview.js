...
innovaphone.ui1.ListView = innovaphone.ui1.ListView || function (out, rowHeight, headercl, arrowcl, vertical) {
    ...
    if (vertical) {
        ...
        header = theader.add(new innovaphone.ui1.Node("tr", "position:absolute; top:0px; width: 100%; left:0px;", null, "headercl"));
        table = out.add(new innovaphone.ui1.Node("table", "position:absolute; top:0px; width: 50%; height: 100%; left:50%;", null, "table"));
    }
    else {
        theader = out.add(new innovaphone.ui1.Node("table", "position:absolute; top:0px; width: 100%; height:" + rowHeight + "px; left:0px;", null, "table"));
        header = theader.add(new innovaphone.ui1.Node("tr", "position:absolute; top:0px; width: 100%; height:100%; left:0px;", null, "headercl"));
        table = out.add(new innovaphone.ui1.Node("table", "position:absolute; top:" + rowHeight + "px; width: 100%; height: 100%; left:0px;", null, "table"));
    }
    ...
    this.addColumn = function (cl, contentcl, content, id, minWidth, int) {
        if (vertical) {
            var headerF = header.add(new innovaphone.ui1.Node("tr", "position:absolute; top:" + cols * rowHeight + "px; height:" + rowHeight + "px; left:0px;  width: 100%; display:block;", null, cl));
    ...
    this.addRow = function (elements, cl, overColor, selectedColor) {
        var row;
        if (vertical) {
            ...
            row = table.add(new innovaphone.ui1.Node("tr", "position:absolute; top:" + top + "px; left:0px; height:" + cols * rowHeight + "px; width:100%;", null, cl));
            rows = rows + 1;
            var rtop = 0;
            for (var i = 0; i < cols; i++) {
                var rowField = row.add(new innovaphone.ui1.Node("tr", "position:absolute; width:100%; left:0px; top:"+rtop+"px; height:" + rowHeight + "px; display:block", null, null));
            ...
            rows = rows + 1;
            row = table.add(new innovaphone.ui1.Node("tr", "position:absolute; top:" + top + "px; left:0px; height:" + rowHeight + "px; width:100%;", null, cl));
            ...
            for (var i = 0; i < cols; i++) {
                ...
                var rowField = row.add(new innovaphone.ui1.Node("td", "position:absolute; left:" + left + "%; height:" + rowHeight + "px; display:block", null, null));
                rowField.add(new innovaphone.ui1.Div("display: inline-block", elements[i]));
                rowField.container.setAttribute("id", elements[i]);
                left = left + width;
            }
    ...
    this.removeRow = function (num) {
        ...
        if (vertical) theader.container.deleteRow(num);
